                ...
                <Popover className="relative">
                  {({ open }) => (
                    <>
                      ...
                      >
                        <Popover.Panel className="absolute z-26 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-2xl lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
              ...
              <Popover.Panel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-transparent divide-y-2 divide-gray-50">
                  ...
                  <div className="py-6 px-5">
                    ...
                    <div className="mt-6">
                      <Link href="/register" className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-teal-600 hover:bg-teal-800 duration-300">
                        Regístrate
                      </Link>
